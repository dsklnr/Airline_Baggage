...
```{r}
# Plot the actual vs. predicted values
plot(pred_hawaiian_q1, main = "Q1 2011 Predictions for Hawaiian Airlines", col = "cornflowerblue" , xlab = "Time", ylab = "Baggage Claims", xlim = c(2004, 2011), ylim = c(1000, 3500))
