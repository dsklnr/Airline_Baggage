...
plot(pred_american_eagle, main = "ARIMA Predictions", xlab = "Time", ylab = "Sales")
...
```{r}
# Plot the actual vs. predicted values
plot(pred_united, main = "ARIMA Predictions", xlab = "Time", ylab = "Sales")
...
```{r}
# Plot the actual vs. predicted values
plot(pred_hawaiian, main = "ARIMA Predictions", xlab = "Time", ylab = "Sales")
