...
plot(pred_american_eagle, main = "ARIMA Predictions", xlab = "Time", ylab = "Baggage Complaints")
...
```{r}
# Plot the actual vs. predicted values
plot(pred_united, main = "ARIMA Predictions", xlab = "Time", ylab = "Baggage Complaints")
...
```{r}
# Plot the actual vs. predicted values
plot(pred_hawaiian, main = "ARIMA Predictions", xlab = "Time", ylab = "Baggage Complaints")
...
```{r}
# Plot the actual vs. predicted values
plot(hwin_pred_ae, main = "Holt-Winter's Predictions", xlab = "Time", ylab = "Baggage Claims", xlim = c(2004, 2011), ylim = c(0, 35000))
lines(ae_ts_train, col = "green", lty = 1, lwd = 2)
lines(hwin_pred_ae$fitted, col = "chartreuse4", lty = 1, lwd = 2)
lines(ae_ts_valid, col = "purple", lty = 1, lwd = 2)

# Create a legend
legend("bottomleft", legend = c("Actual Complaints", "Holt-Winter's Train", "Validation Complaints", "Holt-Winter's Forecast"), col = c("green", "chartreuse4", "purple", "cornflowerblue"), lty = c(1, 1), lwd = c(1, 2))
```
...
# Plot the actual vs. predicted values
plot(ae_ts_valid, main = "Ensemble Forecast", xlab = "Time", ylab = "Sales", col = "purple", lty = 1, lwd = 2, xlim = c(2004, 2011), ylim = c(5000, 30000))
lines(ae_ts_train, col = "green", lty = 1, lwd = 2)
...
```{r}
# Plot the actual vs. predicted values
plot(united_ts_valid, main = "Holt-Winter's Predictions", xlab = "Time", ylab = "Baggage Complaints", col = "purple", lty = 1, lwd = 2, xlim = c(2004, 2011), ylim = c(0, 60000))
...
# Plot the actual vs. predicted values
plot(united_ts_valid, main = "Ensemble Predictions", xlab = "Time", ylab = "Baggage Complaints", col = "purple", lty = 1, lwd = 2, xlim = c(2004, 2011), ylim = c(0, 45000))
lines(united_ts_train, col = "blue", lty = 1, lwd = 2)
...
```{r}
# Plot the actual vs. predicted values
plot(hawaiian_ts_valid, main = "Holt-Winter's vs ARIMA Predictions", xlab = "Time", ylab = "Baggage Complaints", col = "purple", lty = 1, lwd = 2, xlim = c(2004, 2011), ylim = c(1000, 3500))
lines(hawaiian_ts_train, col = "orange", lty = 1, lwd = 2)
...
# Create a legend
legend("topleft", legend = c("Actual Complaints", "Holt-Winter's Train", "Validation Complaints", "Holt-Winter's Train"), 
...
# Plot the actual vs. predicted values
plot(hawaiian_ts_valid, main = "Ensemble Predictions", xlab = "Time", ylab = "Baggage Complaints", col = "purple", lty = 1, lwd = 2, xlim = c(2004, 2011), ylim = c(1000, 3500))
lines(hawaiian_ts_train, col = "orange", lty = 1, lwd = 2)
...
```{r}
# Plot the actual vs. predicted values
plot(hwin_pred_ae_q1, main = "Holt-Winter's Q1 2011 Predictions", xlab = "Time", ylab = "Baggage Claims", xlim = c(2004, 2011), ylim = c(0, 35000))
lines(american_eagle.ts, col = "green", lty = 1, lwd = 2)

# Create a legend
legend("topright", legend = c("Actual Complaints", "Holt-Winter's Complaints", "Q1 Forecast"), col = c("green", "cornflowerblue"), lty = c(1, 1), lwd = c(1, 2))
```
...
# Create a legend
legend("topright", legend = c("Actual Complaints", "Q1 Forecast"), col = c("blue", "cornflowerblue"), lty = c(1, 1), lwd = c(1, 2))
```
...
```{r}
# Plot the actual vs. predicted values
plot(pred_hawaiian_q1, main = "ARIMA Q1 2011 Predictions for Hawaiian Airlines", col = "cornflowerblue" , xlab = "Time", ylab = "Baggage Claims", xlim = c(2004, 2011), ylim = c(1000, 3500))
lines(hawaiian.ts, col = "orange", lty = 1, lwd = 2)

# Create a legend
legend("topright", legend = c("Actual Complaints", "Q1 Forecast"), col = c("orange", "cornflowerblue"), lty = c(1, 1), lwd = c(1, 2))
```
